...
import co.edu.uniandes.csw.servicios.resources.ClienteResource;
import java.io.File;
...
public class ClienteSolicitudServicioIT {

    private static final String COLLECTION = "ClienteSolicitudServicio-Test.postman_collection";
